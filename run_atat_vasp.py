...
def run_atat_vasp():
    ...
    # make sure there are always at least 8 bands
    # for one atom, with one valence electron, you can get 3 bands with this, which is not enough.
    ...
    lines = f.readlines()
    f.close()
    # now we need to modify vasp.in so that runstruct will create the right INCAR with NBANDS in it.
